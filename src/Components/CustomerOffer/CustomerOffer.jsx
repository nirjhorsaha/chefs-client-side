        ...
        <div className='mb-8'>
            ...
            <div className="grid md:grid-cols-4 gap-4 mx-auto justify-center mt-6">
                <div className='text-center italic'>
                    ...
                    <p className="uppercase font-bold text-orange-400">Childrens party</p>
                </div>
                <div className='text-center italic'>
                    ...
                    <p className="uppercase font-bold text-orange-400">social event</p>
                </div>
                <div className='text-center italic'>
                    ...
                    <p className="uppercase font-bold text-orange-400">corporate event</p>
                </div>
                <div className='text-center italic'>
                    ...
                    <p className="uppercase font-bold text-orange-400">wedding</p>
                </div>
            </div>
        </div>
    );
