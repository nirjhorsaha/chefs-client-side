            ...
            <section className="bg-white dark:bg-gray-900 ">
                <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 ">
                    <div className="mr-auto place-self-center lg:col-span-7">
                        <h1 className="max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl dark:text-white ">Best Food For <br /> <span className='text-orange-400 tracking-wide'>Your Taste</span></h1>
                        ...
                        <button href="#" className="inline-flex items-center justify-center px-5 py-3 mb-4 mr-3 text-base font-medium text-center text-orange-400 rounded-full border">
                            Get started
